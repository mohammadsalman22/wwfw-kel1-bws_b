    ...
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            <a href="" class="navbar-brand">
                <h1 class="text-primary"><span class="text-white">Book</span>Wisata</h1>
            </a>
            <p>Kami menyediakan paket wisata lokal dengan berbagai pilihan menarik yang akan membuatmu lebih tenang</p>
