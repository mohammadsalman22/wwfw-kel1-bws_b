...
<div class="content-wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('metode.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> + Tambah Data Baru</a>
    </div>
                          ...
                          <tr>
                            ...
                            <td>
                                <div class="form-inline p-0">
                                    <a href="{{ route('metode.edit',$item->id_pembayaran) }}" class="btn btn-success mr-2" title="Edit" data-toggle="tooltip"> <span class="fa fa-pen"></span> </a>
                                    <form action="{{ route('metode.destroy', $item->id_pembayaran) }}" method="POST">
                                        @csrf
                                        @method('delete')
