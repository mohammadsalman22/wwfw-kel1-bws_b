            ...
            <div class="card shadow mb-4">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="alamat_wisata" name="alamat_wisata" placeholder="Masukkan Alamat Wisata"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="gambar_wisata">Gambar Wisata</label>
                        <input type="file" class="form-control-file" id="gambar_wisata" name="gambar_wisata">
                    </div>
                    <div class="form-group">
                        <label for="deskripsi_wisata">Deskripsi wisata</label>
                        <textarea type="text" class="form-control" id="deskripsi_wisata" name="deskripsi_wisata" placeholder="Masukkan Deskripsi Wisata"></textarea>
                    </div>
                    <div class="form-group">
