            ...
            <div class="card shadow mb-4">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        <label for="jk">Jenis Kelamin :</label> <br>
                            <div class="form-check form-check-inline">
                                <label for="jk">
                                    <input type="radio" value="L" id="jk" name="jk">Laki - laki <br>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" step="any" class="form-control" id="no_hp" name="no_hp" placeholder="Masukkan Nomer Hp">
                    </div>
                    <div class="form-group">
