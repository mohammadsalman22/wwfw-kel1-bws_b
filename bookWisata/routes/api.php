...
Route::get('get-booking-wisata', 'API\BookingController@getBookingWisata');
Route::get('get-booking-travel', 'API\BookingController@getBookingTravel');
...
Route::post('get-profiluser', 'API\UserController@getProfilUser');
